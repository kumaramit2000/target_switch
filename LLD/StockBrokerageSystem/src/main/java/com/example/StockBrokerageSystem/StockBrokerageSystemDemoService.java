...
import com.example.StockBrokerageSystem.models.*;

public class StockBrokerageSystemDemoService {
    StockBrocker stockBroker = StockBrocker.getInstance();

    User user1 = new User("U001", "John Doe", "john@example.com", "1122334455");
    stockBroker.createAccount(user1, 1000);
