...
import services.PropertyHuntService;
import services.PropertyHuntServiceImpl;
...
public class PropertyHutApplication {
    public static void main(String[] args) {
        ...
        //list property (2 api)
        propertyHuntService
                .listProperty("112","A 3BHK for sale", "bellandur", "90L", ListingType.SELL, "1800sq", RoomType.THREE_BHK);

        propertyHuntService
                .listProperty("113","A 2BHK for sale", "sarjapura", "40k", ListingType.RENT, "1500sq", RoomType.TOW_BHK);
        ...
        //7 api
        propertyHuntService.searchProperty("bellandur","90L",ListingType.SELL,"1800sq",RoomType.THREE_BHK);

        currentUser = propertyHuntService.loginUser("testUser2");
        propertyHuntService
                .listProperty("154","A 3BHK for sale3", "bellandur", "90L", ListingType.SELL, "1800sq", RoomType.THREE_BHK);
